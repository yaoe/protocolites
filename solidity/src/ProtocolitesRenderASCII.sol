...
contract ProtocolitesRenderASCII is Ownable {
    ...
    function metadata(uint256 tokenId, Protocolites.TokenData memory data) public view returns (string memory) {
        ...
        string memory animation = string.concat(
            ...
            '.container{text-align:center;padding:', isKid ? '40' : '50', 'px;position:relative;}',
            '.animated-wrapper{position:relative;display:inline-block;}',
            '.ascii-display{font-family:"Courier New",monospace;font-size:', isKid ? '18' : '24', 'px;line-height:', isKid ? '18' : '24', 'px;letter-spacing:0;white-space:pre;margin:0;color:#000;}',
            '@keyframes float{',
            '0%{transform:translate(0,0) rotate(0deg) scale(1);}',
            '10%{transform:translate(var(--tx1),var(--ty1)) rotate(var(--r1)) scale(var(--s1));}',
            '25%{transform:translate(var(--tx2),var(--ty2)) rotate(var(--r2)) scale(var(--s2));}',
            '40%{transform:translate(var(--tx3),var(--ty3)) rotate(var(--r3)) scale(var(--s3));}',
            '55%{transform:translate(var(--tx4),var(--ty4)) rotate(var(--r4)) scale(var(--s4));}',
            '70%{transform:translate(var(--tx5),var(--ty5)) rotate(var(--r5)) scale(1.02);}',
            '85%{transform:translate(var(--tx6),var(--ty6)) rotate(var(--r6)) scale(0.98);}',
            '100%{transform:translate(0,0) rotate(0deg) scale(1);}}',
            '</style></head><body>',
            '<div class="container">',
            '<div class="animated-wrapper" id="wrapper">',
    ...
    function getScript14() private pure returns (string memory) {
        return string.concat(
            ...
            'const maxMove=isKid?25:35;',
            'const duration=1.5+Math.random()*2;',
            'const delay=Math.random()*0.5;',
            'const tx1=((Math.random()-0.5)*maxMove*2)+"px";',
            'const ty1=((Math.random()-0.5)*maxMove*2)+"px";',
            'const tx2=((Math.random()-0.5)*maxMove*2)+"px";',
            'const ty2=((Math.random()-0.5)*maxMove*2)+"px";',
            'const tx3=((Math.random()-0.5)*maxMove*2)+"px";',
            'const ty3=((Math.random()-0.5)*maxMove*2)+"px";',
            'const tx4=((Math.random()-0.5)*maxMove*2)+"px";',
            'const ty4=((Math.random()-0.5)*maxMove*2)+"px";',
            'const tx5=((Math.random()-0.5)*maxMove*2)+"px";',
            'const ty5=((Math.random()-0.5)*maxMove*2)+"px";',
            'const tx6=((Math.random()-0.5)*maxMove*2)+"px";',
            'const ty6=((Math.random()-0.5)*maxMove*2)+"px";',
            'const r1=((Math.random()-0.5)*20)+"deg";',
            'const r2=((Math.random()-0.5)*20)+"deg";',
            'const r3=((Math.random()-0.5)*20)+"deg";',
            'const r4=((Math.random()-0.5)*20)+"deg";',
            'const r5=((Math.random()-0.5)*15)+"deg";',
            'const r6=((Math.random()-0.5)*15)+"deg";',
            'const s1=(0.95+Math.random()*0.1);',
            'const s2=(0.95+Math.random()*0.1);',
            'const s3=(0.95+Math.random()*0.1);',
            'const s4=(0.95+Math.random()*0.1);',
            'wrapper.style.setProperty("--tx1",tx1);',
            'wrapper.style.setProperty("--ty1",ty1);',
            'wrapper.style.setProperty("--tx2",tx2);',
            'wrapper.style.setProperty("--ty2",ty2);',
            'wrapper.style.setProperty("--tx3",tx3);',
            'wrapper.style.setProperty("--ty3",ty3);',
            'wrapper.style.setProperty("--tx4",tx4);',
            'wrapper.style.setProperty("--ty4",ty4);',
            'wrapper.style.setProperty("--tx5",tx5);',
            'wrapper.style.setProperty("--ty5",ty5);',
            'wrapper.style.setProperty("--tx6",tx6);',
            'wrapper.style.setProperty("--ty6",ty6);',
            'wrapper.style.setProperty("--r1",r1);',
            'wrapper.style.setProperty("--r2",r2);',
            'wrapper.style.setProperty("--r3",r3);',
            'wrapper.style.setProperty("--r4",r4);',
            'wrapper.style.setProperty("--r5",r5);',
            'wrapper.style.setProperty("--r6",r6);',
            'wrapper.style.setProperty("--s1",s1);',
            'wrapper.style.setProperty("--s2",s2);',
            'wrapper.style.setProperty("--s3",s3);',
            'wrapper.style.setProperty("--s4",s4);',
